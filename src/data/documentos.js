// Documentos oficiales — mismas fuentes (Google Drive / SISTEC) que el sitio actual.
export const DOCUMENTOS = [
  {
    titulo: 'Guía para el llenado de transparencia del SAT',
    url: 'https://drive.google.com/file/d/1CNu4yHktYnFE2VwTxj6sAbAlvy-lkJDA/view?usp=sharing',
  },
  {
    titulo: 'Reforma a ROP 2025 del 31 de octubre de 2025',
    url: 'https://drive.google.com/file/d/1rt2jnQPimtZSbFfjwfyaHx07as7dfGx0/view?usp=sharing',
  },
  {
    titulo: 'ROP 8 de septiembre 2025',
    url: 'https://drive.google.com/file/d/1ku6XOCwiBm9ONfkCbk1ZSUHxRvXjxvMc/view?usp=sharing',
  },
  {
    titulo: 'ROP 11 de septiembre 2024',
    url: 'https://drive.google.com/file/d/1nSOgRML7kyfMQSc6yQpC5vz2a0T3m0Tv/view',
  },
  {
    titulo: 'ROP 20 de marzo 2020',
    url: 'https://drive.google.com/file/d/1bz8EGy_dm1wO7E4y6cOnMeVneEB1wPFw/view?usp=sharing',
  },
  {
    titulo: 'Ley de Fomento a la Sociedad Civil Organizada para el Estado de N.L.',
    url: 'https://drive.google.com/file/d/1p2oTJGjjHJ4fbHQTuzrKTyohOIJ9ycez/view',
  },
  {
    titulo: 'Reglamento de la Ley de Fomento de la Sociedad Civil Organizada para el Estado de Nuevo León',
    url: 'https://sistec.nl.gob.mx/Transparencia_2015/Archivos/AC_0001_0004_0171356-0000001.pdf',
  },
  {
    titulo: 'Aviso de privacidad',
    url: 'https://drive.google.com/file/d/1287tG3nAO3RMWfZbBi29yOhyfE1MWO9k/view',
  },
  {
    titulo: 'Programa Fomento a OSC',
    url: 'https://www.nl.gob.mx/es/programa-fomento-organizaciones-de-la-sociedad-civil-osc',
  },
  {
    titulo: 'Acuerdo de Registro Estatal de OSC',
    url: 'https://drive.google.com/file/d/12DkYLaGaIAU0Tjr2KaH5i4Csi8Dxh0vO/view?usp=sharing',
  },
  {
    titulo: 'Criterios de apoyo a OSC 2009',
    url: 'https://drive.google.com/file/d/12mgGnh7jX1hx-_mLC8iOl1TTP_4w-Fzr/view?usp=sharing',
  },
  {
    titulo: 'Criterios de apoyo a OSC 2015',
    url: 'https://drive.google.com/file/d/1ua1wZqtWsaW-Wruqyj19GZGb36Kd4KVq/view?usp=sharing',
  },
]
...
// Teoría del Cambio — videos educativos que viven en Multimedia > Material de Apoyo
// (NO en Videos OSC's, que tiene contenido distinto: perfiles de organizaciones).
export const TEORIA_DEL_CAMBIO = [
  { id: 'Cfqzj8wAbek', titulo: 'Teoría de Cambio', canal: 'canalsocialab' },
  { id: 'DJVKAwHdetQ', titulo: '1. Teoría de Cambio', canal: 'Proyecto Indigo' },
  { id: 'GeLUeDuUGY0', titulo: '¿Qué es la Teoría de Cambio?', canal: 'Consejo Nuevo León' },
  { id: 'A_N4YSZQQ70', titulo: 'Cap. 3: ¿Qué es la Teoría de Cambio?', canal: 'MOOC Español' },
]

// Videos OSC's — perfiles reales de organizaciones, cada uno con su propio video y
// descripción (tomados del sitio original). `videoId: null` = falta el video de Drive;
// ábrelo en el sitio original y copia el ID de la URL de Drive para completarlo aquí.
export const VIDEOS_OSC = [
  {
    organizacion: 'Una Promesa para la Senectud, A.C.',
    driveId: '18yxHuTDAQUcUvHwJyKFucta08ZZDPw3n',
    descripcion:
      'Una casa de retiro para personas mayores en estado de vulnerabilidad que viven en nuestro estado. A través de este video, presentamos la labor de esta organización comprometida con promover el envejecimiento activo, fomentar el aprendizaje y la protección de las personas mayores, brindándoles una vida digna.',
  },
  {
    organizacion: 'Asociación Lobos MG, A.C. — Infancia Plena',
    driveId: '1-fFrHcX_pidS7PWlhs7mgc6vhht4KDV1',
    descripcion:
      'Infancia Plena, A.C. es un espacio enfocado en la protección de los derechos humanos y la erradicación de la violencia contra las mujeres en periodo de embarazo, lactancia y crianza. Este video presenta la labor de la organización acompañando a mujeres en relación con sus derechos durante la lactancia y la protección de la parentalidad positiva.',
  },
  {
    organizacion: 'Centro Pedagógico Cometa, A.C.',
    driveId: '1Ha_4Tgf-vHv5sq6f9P0aauuhHMZLa9v2',
    descripcion:
  ...
  },
  {
    ...
    driveId: '1sjJkkRAbwyv_PA31pCuXtno772bSD9mE',
    descripcion:
  ...
  },
  {
    ...
    driveId: '1KVXpxKWgGYKDSaJtUZe0uobFY9tKs-Us',
    descripcion:
...
// Comité Técnico para el Fomento de las Actividades de las Organizaciones de la
// Sociedad Civil (CFTA) — Atribuciones e integrantes reales.
export const COMITE_ATRIBUCIONES = [
  'Coadyuvar en la creación y ejecución las Políticas Públicas para el fomento de las actividades de las organizaciones de la sociedad civil;',
  'Realizar la evaluación de las políticas públicas y acciones referentes al fomento de las actividades que señala la Ley;',
  'Promover el diálogo continuo entre los sectores público, social y privado para mejorar las políticas públicas relacionadas a las actividades señaladas en esta Ley;',
  'Apoyar en la elaboración de criterios para la priorización y orientación de los recursos públicos destinados a fomentar las actividades de las organizaciones de la sociedad civil;',
  'Vigilar el adecuado registro, aplicación y manejo de los recursos públicos destinados a fomentar las actividades de las organizaciones de la sociedad civil;',
  'Vigilar el adecuado registro de las redes y agrupaciones;',
  'Denunciar ante la autoridad competente cualquier incumplimiento de esta Ley y de la normatividad aplicable en la materia;',
  'Expedir su reglamento interior; y',
  'Las demás que señale la Ley.',
]

// `foto: null` = falta la fotografía real; usa iniciales como respaldo mientras tanto.
export const COMITE_INTEGRANTES = [
  { nombre: 'Félix Guadalupe Arratia Cruz', rol: 'En representación de la persona Titular del Poder Ejecutivo del Estado de Nuevo León.', categoria: 'Gobierno | Secretaría de Igualdad e Inclusión' },
  { nombre: 'Fernando J. Villarreal Caballero', rol: 'En representación de la persona Titular de la Secretaría de Igualdad e Inclusión.', categoria: 'Gobierno | Secretaría de Igualdad e Inclusión' },
  { nombre: 'Azucena Báez Martínez', rol: 'En representación de la persona Titular de la Subsecretaría de Inversión Social y Alianzas Estratégicas.', categoria: 'Gobierno | Secretaría de Igualdad e Inclusión' },
  { nombre: 'César Sandoval Leal', rol: 'En representación de la persona Titular de la Secretaría de Salud.', categoria: 'Gobierno | Secretaría de Salud' },
  { nombre: 'Karen Sarahí Oviedo Oviedo', rol: 'En representación de la persona Titular de la Secretaría de Educación.', categoria: 'Gobierno | Secretaría de Educación' },
  { nombre: 'Roberto Canales Martínez', rol: 'En representación de la Junta de Beneficencia Privada de Nuevo León.', categoria: 'Ciudadano | Junta de Beneficencia Privada' },
  { nombre: 'Héctor Julián Morales Rivera', rol: 'Persona diputada integrante de la Comisión de Desarrollo Social, Derechos Humanos y Asuntos Indígenas, del H. Congreso del Estado de N.L.', categoria: 'Diputado | H. Congreso del Estado de N.L.' },
  { nombre: 'Luis Agustín Landa García Téllez', rol: 'En representación de las Organizaciones de la Sociedad Civil de Nuevo León.', categoria: 'Ciudadano | Vía Educación, A.C.' },
  { nombre: 'Elker González Forstner', rol: 'En representación de las Organizaciones de la Sociedad Civil de Nuevo León.', categoria: 'Ciudadana | Fundación H.E.B. México' },
  { nombre: 'Bárbara Diego Pérez', rol: 'En representación de las Organizaciones de la Sociedad Civil de Nuevo León.', categoria: 'Ciudadana | El Futuro del Cuidado, A.C.' },
  { nombre: 'Mariana Aguirre Quiroga', rol: 'En representación de las Organizaciones de la Sociedad Civil de Nuevo León.', categoria: 'Ciudadana | Fundación RIISA' },
  { nombre: 'Germán García Fabregat Esquivel', rol: 'En representación de las Organizaciones de la Sociedad Civil de Nuevo León.', categoria: 'Ciudadano | Instituto de Contadores Públicos de Nuevo León' },
  { nombre: 'Luis Enrique Portales Derbéz', rol: 'En representación de las Universidades del Estado de Nuevo León.', categoria: 'Ciudadano | Tecnológico de Monterrey' },
  { nombre: 'Juan Humberto Silva Daniel', rol: 'Secretario Técnico del Comité, nombrado por la persona Titular de la Secretaría de Igualdad e Inclusión.', categoria: 'Gobierno | Secretaría de Igualdad e Inclusión' },
]

export const COMITE_CONTACTO = {
  nombre: 'Nancy Edith López Cantú',
  rol: 'Responsable del Comité y del Consejo — atención, seguimiento y acompañamiento.',
  correo: 'nancy.lopez@nuevoleon.gob.mx',
}

// Compartido por Comité y Consejo — Informes Anuales.
export const ORGANOS_INFORMES = [
  { titulo: 'Informe Anual 2023', url: 'https://drive.google.com/file/d/1Qx-bVx3zaZHD83L915AWYlZBwNTt3JZt/view' },
  { titulo: 'Informe Anual 2024', url: 'https://drive.google.com/file/d/1LS6uWFDfgEBtrAR0JEgJlfQw6hPf3L7P/view' },
  { titulo: 'Informe Anual 2025', url: 'https://drive.google.com/file/d/1Nkmtmy7NIHS3AGXUsk11e3DZ7wxp_r2Z/view' },
]

// Consejo Consultivo de Fomento a la Sociedad Civil (CCFSC).
export const CONSEJO_INTRO =
  'El Consejo Consultivo de Fomento a la Sociedad Civil es un órgano de asesoría y consulta que promueve la colaboración entre el gobierno y las organizaciones de la sociedad civil para desarrollar políticas públicas más inclusivas y efectivas. Su misión es facilitar la participación ciudadana en la creación, evaluación y seguimiento de estas políticas, asegurando que las iniciativas de bienestar social respondan a las necesidades reales de la población.'

export const CONSEJO_ATRIBUCIONES = [
  'Analizar las políticas públicas del Estado y los Municipios relacionadas con el fomento de las actividades de las organizaciones de la sociedad civil, agrupaciones y redes señaladas en esta Ley, así como formular opiniones y propuestas sobre su aplicación y orientación;',
  'Impulsar la participación ciudadana y de las organizaciones de la sociedad civil para la elaboración de programas y propuestas que puedan ser sometidas a consideración del Comité para elaborar políticas públicas que se traduzcan en beneficios para la sociedad;',
  ...
  'Las demás que señale esta Ley y la legislación aplicable.',
]

export const CONSEJO_INTEGRANTES = [
  { nombre: 'Mayte Cárdenas Ortiz', rol: 'Persona Titular, Presidenta Ciudadana.', categoria: 'Ciudadana | Fundación Promover, A.C.' },
  { nombre: 'Fernando J. Villarreal Cabellero', rol: 'Servidor público representante de la Secretaría de Igualdad e Inclusión — Secretario Ejecutivo.', categoria: 'Gobierno | Secretaría de Igualdad e Inclusión' },
  { nombre: 'Ana Diameleth Osuna Maldonado', rol: 'Servidora pública representante de la Secretaría de Medio Ambiente — Consejera.', categoria: 'Gobierno | Secretaría de Medio Ambiente' },
  { nombre: 'María Mirtala Cavazos Parra', rol: 'Servidora pública representante de la Secretaría de Salud — Consejera.', categoria: 'Gobierno | Secretaría de Salud' },
  { nombre: 'Karen Sarahí Oviedo Oviedo', rol: 'Servidora pública representante de la Secretaría de Educación — Consejera.', categoria: 'Gobierno | Secretaría de Educación' },
  { nombre: 'Marco Antonio Amaya Díaz', rol: 'Representante Académico — Consejero.', categoria: 'Ciudadano | Instituto Nuevo Amanecer, A.B.P.' },
  { nombre: 'Luis Eduardo Zavala de Alba', rol: 'Representante Científico, Consejero.', categoria: 'Ciudadano | Casa Monarca, Ayuda Humanitaria al Migrante, A.B.P.' },
  { nombre: 'S. Gabriela Sagaón Sánchez', rol: 'Representante Cultural, Consejera.', categoria: 'Ciudadana | Secretaría de Igualdad e Inclusión' },
  { nombre: 'Arely González de Hoyos', rol: 'Representante Profesional, Consejera.', categoria: 'Ciudadana | Andamos México' },
  { nombre: 'Ana Nora Peters de la Garza', rol: 'Representante Ciudadana, Consejera.', categoria: 'Ciudadana | Effeta, A.B.P.' },
  { nombre: 'Enoc Eliseo Mojica Sauza', rol: 'Representante Ciudadano, Consejero.', categoria: 'Ciudadano | Villas Asistenciales Santa María, A.B.P.' },
  { nombre: 'Grethy R. Manzanares Garmendia', rol: 'Representante Ciudadana, Consejera.', categoria: 'Ciudadana | Asociación de Nicaragüenses en México, A.C.' },
  { nombre: 'Jorge A. Lozano Morales', rol: 'Representante Ciudadano — Consejero.', categoria: 'Ciudadano | Hagámoslo Bien por una Cultura de la Legalidad, A.C.' },
  { nombre: 'Gerard Prado Hernández', rol: 'Representante Ciudadano — Consejero.', categoria: 'Ciudadano | Fundación Apleseed México, A.C.' },
  { nombre: 'Arturo Monreal del Razo', rol: 'Representante Ciudadano, Consejero.', categoria: 'Ciudadano | Fomento Moral y Educativo, A.C.' },
  { nombre: 'Érika Laveaga Bermudez', rol: 'Representante Ciudadana, Consejera.', categoria: 'Ciudadana | Impacto Colectivo' },
]

export const CONSEJO_CONTACTO = {
  nombre: 'Nancy Edith López Cantú',
  rol: 'Secretaria Técnico del Consejo, nombrada por la persona Titular de la Secretaría de Igualdad e Inclusión.',
  correo: 'nancy.lopez@nuevoleon.gob.mx',
}
...
export const REDES = [
  ...
  { label: 'X', url: 'https://x.com/igualdadnl' },
  { label: 'YouTube', url: 'https://youtube.com/@igualdadnl' },
]

// Directorio de OSC — muestra de ejemplo tomada del registro público.
// Sustituye este arreglo por el CSV/API real cuando esté disponible.
export const DIRECTORIO_MUESTRA = [
  {
    organizacion: '10 X Ciénega, A.C.',
    rubro: 'Servicios médicos',
    municipio: 'Ciénega de Flores',
    direccion: 'Zaragoza 205, Centro',
    correo: 'diezxcienega@hotmail.com',
    telefono: '01 (825) 2380-794',
  },
  {
    organizacion: '10,000 Mujeres Unidas por México, A.C.',
    rubro: 'Educación',
    municipio: 'Monterrey',
    direccion: 'Carlos Salazar 528, Centro',
    correo: 'irasema10000@gmail.com',
    telefono: '811-290-4208',
  },
  {
    organizacion: 'AFORAIDS México, A.C.',
    rubro: 'Atención social',
    municipio: 'San Nicolás de los Garza',
    direccion: 'Francisco I. Madero 519, Centro',
    correo: 'jlopez@aidforaids.org',
    telefono: '(81) 1095-5440',
  },
  {
    organizacion: 'AFP Capítulo Monterrey, A.C.',
    rubro: 'Capacitación general',
    municipio: 'Monterrey',
    direccion: 'Uruguay 111, Vista Hermosa',
    correo: 'afp.monterrey@gmail.com',
    telefono: '81-10-80-01-78',
  },
  {
    organizacion: 'AIESEC México, A.C.',
    rubro: 'Educación',
    municipio: 'Monterrey',
    direccion: 'Luis Elizondo 416 A, Alta Vista',
    correo: 'presidente.mty@aiesec.org.mx',
    telefono: '5517313236',
  },
]
